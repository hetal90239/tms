...
<head>
  ...
  <title>Task Management Sys | Pending View Page</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Pending Task View</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Pending View</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <tbody>
                    ...
                    <tr>
                       ...
                       <td>{{ $user->tasktitle }}</td>
                        ...
                        <td><a href="/taskcompleted/{{ $user->id }}">Completed</a></td>
                    </tr>
                    @endforeach   
                 </tbody>
                </table>
